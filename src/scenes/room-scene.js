...
export default class RoomScene extends Phaser.Scene {
	...
	preload() {
		...
		this.load.image("glasses", "assets/textures/glasses.png");
		this.load.image("digits", "assets/textures/digits.png");
		this.load.image("padlock", "assets/textures/padlock.png");
		this.load.image("padlock-unlocked", "assets/textures/padlock-unlocked.png");
		this.load.image("lamp", "assets/textures/lamp.png");
		this.load.image("lamp-switch", "assets/textures/lamp-switch.png");
		this.load.image("lamp-light", "assets/textures/lamp-light.png");
		this.load.image("notebook-page1", "assets/textures/notebook-page1.png");
		this.load.image("notebook-page2", "assets/textures/notebook-page2.png");
		this.load.image("picture", "assets/textures/picture.png");
		this.load.image("picture-blur", "assets/textures/picture-blur.png");
		this.load.image("switch-on", "assets/textures/switch-on.png");
		this.load.image("switch-off", "assets/textures/switch-off.png");
		this.load.image("television", "assets/textures/television.png");
		this.load.image("snow", "assets/textures/snow.png");
		this.load.image("wedding", "assets/textures/wedding.png");
		this.load.image("closet-door-closed", "assets/textures/closet-door-closed.png");
		this.load.image("closet-door-opened", "assets/textures/closet-door-opened.png");
		this.load.image("videotape", "assets/textures/videotape.png");
		this.load.image("calendar", "assets/textures/calendar-july.png");
